            ...
            <form action="{{ route('records.update', $record->id) }}" method="POST">
                ...
                <div class="mt-4">
                    ...
                    <textarea name="reason"
                        class="w-full border-[#e7a739] bg-white rounded-md px-3 py-2 focus:ring-[#9f234a]">{{ old('reason', $record->reason) }}</textarea>
                ...
                <div class="mt-4">
                    ...
                    <select name="charged"
                        class="w-full border-[#e7a739] bg-white rounded-md px-3 py-2 focus:ring-[#9f234a]">
                        <option value="1" {{ $record->charged == 1 ? 'selected' : '' }}>Yes</option>
                        <option value="0" {{ $record->charged == 0 ? 'selected' : '' }}>No</option>
                    </select>
                ...
                <div class="mt-4">
                    ...
                    <textarea name="comment"
                        class="w-full border-[#e7a739] bg-white rounded-md px-3 py-2 focus:ring-[#9f234a]">{{ old('comment', $record->comment) }}</textarea>

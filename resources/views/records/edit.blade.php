            ...
            <form action="{{ route('records.update', $record->id) }}" method="POST">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="text" name="first_name" value="{{ old('first_name', $record->first_name) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="last_name" value="{{ old('last_name', $record->last_name) }}"
                            class="w-full border-[#e7a739] bg-white rounded px-3 py-1.5 focus:ring-[#9f234a]">
                        @error('last_name')
                            <span class="text-red-500 text-xs block mt-1">{{ $message }}</span>
                        @enderror
                ...
                <div class="grid grid-cols-2 gap-3 mt-3">
                    <div>
                        ...
                        <input type="text" name="address1" value="{{ old('address1', $record->address1) }}"
                            class="w-full border-[#e7a739] bg-white rounded px-3 py-1.5 focus:ring-[#9f234a]">
                        @error('address1')
                            <span class="text-red-500 text-xs block mt-1">{{ $message }}</span>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="address2" value="{{ old('address2', $record->address2) }}"
                            class="w-full border-[#e7a739] bg-white rounded px-3 py-1.5 focus:ring-[#9f234a]">
                        @error('address2')
                            <span class="text-red-500 text-xs block mt-1">{{ $message }}</span>
                        @enderror
                ...
                <div class="grid grid-cols-3 gap-3 mt-3">
                    <div>
                        ...
                        <input type="text" name="city" value="{{ old('city', $record->city) }}"
                            class="w-full border-[#e7a739] bg-white rounded px-3 py-1.5 focus:ring-[#9f234a]">
                        @error('city')
                            <span class="text-red-500 text-xs block mt-1">{{ $message }}</span>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="state" value="{{ old('state', $record->state) }}"
                            class="w-full border-[#e7a739] bg-white rounded px-3 py-1.5 focus:ring-[#9f234a]">
                        @error('state')
                            <span class="text-red-500 text-xs block mt-1">{{ $message }}</span>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="zip" value="{{ old('zip', $record->zip) }}"
                            class="w-full border-[#e7a739] bg-white rounded px-3 py-1.5 focus:ring-[#9f234a]">
                        @error('zip')
                            <span class="text-red-500 text-xs block mt-1">{{ $message }}</span>
                        @enderror
                ...
                <div class="mt-3">
                    ...
                    <textarea name="reason" rows="1"
                        class="w-full border-[#e7a739] bg-white rounded px-3 py-1.5 focus:ring-[#9f234a]">{{ old('reason', $record->reason) }}</textarea>
                    @error('reason')
                        <span class="text-red-500 text-xs block mt-1">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-2 gap-3 mt-3">
                    <div>
                        ...
                        <select name="charged"
                            class="w-full border-[#e7a739] bg-white rounded px-3 py-1.5 focus:ring-[#9f234a]">
                            <option value="1" {{ old('charged', $record->charged) == 1 ? 'selected' : '' }}>Yes</option>
                            <option value="0" {{ old('charged', $record->charged) == 0 ? 'selected' : '' }}>No</option>
                        </select>
                        @error('charged')
                            <span class="text-red-500 text-xs block mt-1">{{ $message }}</span>
                        @enderror
                    ...
                    <div>
                        ...
                        <textarea name="comment" rows="1"
                            class="w-full border-[#e7a739] bg-white rounded px-3 py-1.5 focus:ring-[#9f234a]">{{ old('comment', $record->comment) }}</textarea>
                        @error('comment')
                            <span class="text-red-500 text-xs block mt-1">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-2 gap-3 mt-3">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ $record->created_at->format('Y-m-d') }}" readonly
                            class="w-full border-[#e7a739] bg-gray-200 rounded px-3 py-1.5">
                    </div>
                </div>
